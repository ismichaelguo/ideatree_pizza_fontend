	...
	return (
		<div>
			<div className="store-searchbox">
				<div className="store-searchbox-box">
					<div className="store-searchbox-title">FIND YOUR LOCAL PIZZAHUB</div>
			...
			<div className="store-explore">
				<div className="store-explore-title">
					<strong>EXPLORE</strong>
					<br />
					BY STATE
				</div>

				{StoreList.map((item) => (<div className="store-explore-city" key={item.stateId}>
					<Link to={`/store-in-state/${item.stateId}/${item.states}`}>
						<strong className="store-explore-city1">{item.states}</strong>
					</Link>
